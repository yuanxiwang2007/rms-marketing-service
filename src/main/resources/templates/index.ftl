...
<#if max??>
    ...
    <#if pageInfo??>
        <table class="gridtable" style="width:100%;">
            <tr>
                <th colspan="2">分页信息 - [<a href="javascript:;" keyID="list">展开/收缩</a>]</th>
            </tr>
            <tr class="pageDetail">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">[<a
                            href="${request.contextPath}/countries/view/${country.keyID}">修改</a>] -
                        [<a href="${request.contextPath}/countries/delete/${country.keyID}">删除</a>]
                    </td>
                </tr>
                </#list>
            </tbody>
